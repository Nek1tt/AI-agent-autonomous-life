...
- Абрамов Никита — Backend разработка, разработка AI и BDI архитектуры
- Абдылдаев Нуршат — Backend разработка, настройка и установка БД
- Порошков Виктор — Frontend разработка
